...
// rectangulos: número de pares de rectangulos para cada jogo
    ...
    public static Square[][] getRectangles( SimpleGfxGrid grid) {
        ...
        Square[][] rectanglesContainer = new Square[grid.getCols()][5];
        ...
        for (int i = 0; i < rectanglesContainer.length; i++) {
            ...
            twoRects[0] = new Square(0, 1, grid, ColorEnum.RED);
            twoRects[1] = new Square(1, 4, grid, ColorEnum.RED);

            twoRects1[0] = new Square(2, 0, grid, ColorEnum.BLUE);
            twoRects1[1] = new Square(1, 3, grid, ColorEnum.BLUE);

            twoRects2[0] = new Square(2, 1, grid, ColorEnum.MAGENTA);
            twoRects2[1] = new Square(2, 4, grid, ColorEnum.MAGENTA);

            twoRects3[0] = new Square(4, 0, grid, ColorEnum.GREEN);
            twoRects3[1] = new Square(3, 3, grid, ColorEnum.GREEN);

            twoRects4[0] = new Square(4, 1, grid, ColorEnum.ORANGE);
            twoRects4[1] = new Square(3, 4, grid, ColorEnum.ORANGE);
        }
